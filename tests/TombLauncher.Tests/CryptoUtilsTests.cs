...
public class CryptoUtilsTests
{
    ...
    public void ComputeMd5Hash_EmptyArrayReturnsKnownMd5()
    {
        ...
        var md5 = CryptoUtils.ComputeMd5Hash(data);
    ...
    public async Task ComputeMd5Hash_EmptyStreamReturnsKnownMd5()
    {
        ...
        var md5 = await CryptoUtils.ComputeMd5Hash(data);
    ...
    public async Task ComputeMd5Hash_AreVariantsConsistent()
    {
        ...
        var fromMemoryStream = await CryptoUtils.ComputeMd5Hash(new MemoryStream(bytes));
        var fromArray = CryptoUtils.ComputeMd5Hash(bytes);
